...
def isgood_signal(rsi, stoch, price, high, low, macd, histogram, signal):
    ...
    for date in fdate:
        ...
        if rsi[date] > 48 and stoch[date] < 30 and in_long_position == False and in_short_position == False and date == signals[n]:
            if param > 25 or param < -40 or params > 2 or params < -2 or sparam < -.65 or sparams > 2.6 or sparams < -6:
                pass
            ...
            if param > 25 or param < -40 or params > 1.25 or params < 0.45 or sparam < -.65 or sparams > 2.6 or sparams < -6:
                pass
